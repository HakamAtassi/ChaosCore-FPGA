...
set top_module "ChaosCoreTop"


set project_name "ChaosCore"
set project_dir "./ChaosCore"
...
set lib_dir [file normalize "/mnt/Storage/SCHOOL/Capstone/ChaosCore-chipyard/sims/verilator/generated-src/chipyard.harness.TestHarness.ChaosCoreFPGAConfig/gen-collateral"]
set constraints_dir [file normalize "./constraints"]

# add sources
set fp [open "$lib_dir/../chipyard.harness.TestHarness.ChaosCoreFPGAConfig.all.f" r]
   while {[gets $fp line] >= 0} {
   read_verilog -sv "$line"
}

#add_files /mnt/Storage/SCHOOL/Capstone/bringup/ChaosCore-FPGA/RV32RocketFPGAConfig/RV32RocketFPGAConfig/gen-collateral/RV32RocketCoreTop.v
...
# # to just open the BD
# #update_compile_order -fileset sources_1
# #open_bd_design {/mnt/Storage/SCHOOL/Capstone/bringup/ChaosCore-FPGA/RV32RocketFPGAConfig/RV32Rocket/RV32Rocket.srcs/sources_1/bd/BD/BD.bd}
...
# create_bd_port -dir I uart_tsi_rx
# connect_bd_net [get_bd_ports uart_tsi_rx] [get_bd_pins core/uart_tsi_uart_rxd]

# create_bd_port -dir O uart_tsi_tx
# connect_bd_net [get_bd_ports uart_tsi_tx] [get_bd_pins core/uart_tsi_uart_txd]

# create_bd_port -dir O rst_led
# connect_bd_net [get_bd_ports rst_led] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
# #################
# # Set addresses #
# #################
...
# # add BD wrapper
# make_wrapper -files [get_files /mnt/Storage/SCHOOL/Capstone/bringup/ChaosCore-FPGA/RV32RocketFPGAConfig/RV32Rocket/RV32Rocket.srcs/sources_1/bd/BD/BD.bd] -top
# add_files -norecurse /mnt/Storage/SCHOOL/Capstone/bringup/ChaosCore-FPGA/RV32RocketFPGAConfig/RV32Rocket/RV32Rocket.gen/sources_1/bd/BD/hdl/BD_wrapper.v
# update_compile_order -fileset sources_1
...
# generate_target all [get_files /mnt/Storage/SCHOOL/Capstone/bringup/ChaosCore-FPGA/RV32RocketFPGAConfig/RV32Rocket/RV32Rocket.srcs/sources_1/bd/BD/BD.bd]
# create_ip_run [get_files -of_objects [get_fileset sources_1] /mnt/Storage/SCHOOL/Capstone/bringup/ChaosCore-FPGA/RV32RocketFPGAConfig/RV32Rocket/RV32Rocket.srcs/sources_1/bd/BD/BD.bd]
# launch_runs BD_core_0_synth_1 BD_zynq_ultra_ps_e_0_0_synth_1 -jobs 8

# wait_on_run BD_core_0_synth_1 BD_zynq_ultra_ps_e_0_0_synth_1
# synth_design -rtl -rtl_skip_mlo -name rtl_1

# set_property IOSTANDARD LVCMOS18 [get_ports [list uart_tsi_rx]]
# set_property IOSTANDARD LVCMOS18 [get_ports [list uart_tsi_tx]]
# place_ports uart_tsi_rx C5
# place_ports uart_tsi_tx G6

# set_property IOSTANDARD LVCMOS18 [get_ports [list rst_led]]
# place_ports rst_led A7

# set_property target_constrs_file /mnt/Storage/SCHOOL/Capstone/bringup/ChaosCore-FPGA/RV32RocketFPGAConfig/constraints/constraints.xdc [current_fileset -constrset]
...
# write_hw_platform -fixed -include_bit -force -file /mnt/Storage/SCHOOL/Capstone/bringup/ChaosCore-FPGA/RV32RocketFPGAConfig/RV32Rocket/BD_wrapper.xsa
