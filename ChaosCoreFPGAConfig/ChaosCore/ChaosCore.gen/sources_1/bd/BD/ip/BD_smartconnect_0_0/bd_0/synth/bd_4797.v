...
//--------------------------------------------------------------------------------
//Command: generate_target bd_4797.bd
//Design : bd_4797
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_4797,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_4797,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=51,numReposBlks=41,numNonXlnxBlks=0,numHierBlks=10,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=None}" *) (* HW_HANDOFF = "BD_smartconnect_0_0.hwdef" *) 
module bd_4797
   (M00_AXI_araddr,
    M00_AXI_arburst,
    M00_AXI_arcache,
    ...
    aclk1,
    aresetn);
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 M00_AXI ARADDR" *) (* X_INTERFACE_MODE = "Master" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME M00_AXI, ADDR_WIDTH 49, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN BD_ChaosCoreTop_0_0_M_AXI_MEM_ACLK, DATA_WIDTH 128, FREQ_HZ 50000000, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 128, NUM_READ_OUTSTANDING 2, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 2, NUM_WRITE_THREADS 1, PHASE 0.0, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) output [48:0]M00_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 M01_AXI ARADDR" *) (* X_INTERFACE_MODE = "Master" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME M01_AXI, ADDR_WIDTH 19, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN BD_ChaosCoreTop_0_0_M_AXI_MMIO_ACLK, DATA_WIDTH 32, FREQ_HZ 50000000, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 256, NUM_READ_OUTSTANDING 2, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 2, NUM_WRITE_THREADS 1, PHASE 0.0, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0" *) output [18:0]M01_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ACLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ACLK, ASSOCIATED_BUSIF M00_AXI:S00_AXI, ASSOCIATED_CLKEN m_sc_aclken, CLK_DOMAIN BD_ChaosCoreTop_0_0_M_AXI_MEM_ACLK, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input aclk;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ACLK1 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ACLK1, ASSOCIATED_BUSIF M01_AXI:S01_AXI, ASSOCIATED_CLKEN s_sc_aclken, CLK_DOMAIN BD_ChaosCoreTop_0_0_M_AXI_MMIO_ACLK, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input aclk1;
  ...
  wire [140:0]s01_nodes_M_SC_AR_PAYLD;
  ...
  wire [140:0]s01_nodes_M_SC_AW_PAYLD;
  ...
  wire [160:0]s01_nodes_M_SC_W_PAYLD;
  ...
  m00_exit_pipeline_imp_GG5XX3 m00_exit_pipeline
  ...
  m00_nodes_imp_TTPGBF m00_nodes
  ...
  m01_exit_pipeline_imp_CBAAEV m01_exit_pipeline
  ...
  m01_nodes_imp_1WDOBSD m01_nodes
  ...
  s00_entry_pipeline_imp_1F5Q4MS s00_entry_pipeline
       (.aclk(aclk_1),
        .aresetn(aresetn_2),
  ...
  s00_nodes_imp_1C8HDRI s00_nodes
  ...
  s01_entry_pipeline_imp_9QBRXC s01_entry_pipeline
       (.aclk(aclk_2),
        .aresetn(aresetn_3),
  ...
  s01_nodes_imp_DJVLP4 s01_nodes
  ...
  switchboards_imp_1IZMK8Q switchboards
...
module clk_map_imp_1ICU6NG
  ...
  assign M01_ACLK = aclk1;
  assign S00_ACLK = swbd_aclk;
  assign S00_ARESETN[0] = swbd_aresetn;
  assign S01_ACLK = M01_ACLK;
  assign S01_ARESETN[0] = M01_ARESETN;
  ...
  bd_4797_psr_aclk1_0 psr_aclk1
       (.aux_reset_in(aresetn),
        .dcm_locked(1'b1),
        .ext_reset_in(psr0_interconnect_aresetn),
        .interconnect_aresetn(M01_ARESETN),
        .mb_debug_sys_rst(1'b0),
        .slowest_sync_clk(M01_ACLK));
endmodule
...
module m01_exit_pipeline_imp_CBAAEV
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arburst,
...
module s00_entry_pipeline_imp_1F5Q4MS
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arcache,
  ...
  bd_4797_s00mmu_0 s00_mmu
       (.aclk(aclk),
        ...
        .s_axi_wstrb(s_axi_wstrb),
        .s_axi_wvalid(s_axi_wvalid));
  bd_4797_s00sic_0 s00_si_converter
       (.aclk(aclk),
        .aresetn(aresetn),
        .m_axi_araddr(m_axi_araddr),
        .m_axi_arcache(m_axi_arcache),
  ...
  bd_4797_s00tr_0 s00_transaction_regulator
       (.aclk(aclk),
        .aresetn(aresetn),
...
module s01_entry_pipeline_imp_9QBRXC
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arcache,
  ...
  bd_4797_s01mmu_0 s01_mmu
       (.aclk(aclk),
        ...
        .s_axi_wstrb(s_axi_wstrb),
        .s_axi_wvalid(s_axi_wvalid));
  bd_4797_s01sic_0 s01_si_converter
       (.aclk(aclk),
        .aresetn(aresetn),
        .m_axi_araddr(m_axi_araddr),
        .m_axi_arcache(m_axi_arcache),
  ...
  bd_4797_s01tr_0 s01_transaction_regulator
       (.aclk(aclk),
        .aresetn(aresetn),
...
module switchboards_imp_1IZMK8Q
   (M00_SC_AR_info,
    M00_SC_AR_payld,
    M00_SC_AR_recv,
    M00_SC_AR_req,
  ...
  assign M01_SC_B_payld[6:0] = \^M01_SC_B_payld [13:7];
  ...
  assign M01_SC_R_payld[148:0] = \^M01_SC_R_payld [297:149];
  ...
  assign M01_SC_W_payld[160:0] = \^M01_SC_W_payld [321:161];
