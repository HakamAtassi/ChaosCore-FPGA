...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "./.Xil/Vivado-257851-Desktop-Home/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      ...
      rt::read_verilog /mnt/Storage/SCHOOL/Capstone/bringup/ChaosCore-FPGA/ChaosCoreFPGAConfig/ChaosCore/ChaosCore.srcs/sources_1/new/AXI_data_snoop.v
      rt::read_verilog /mnt/Storage/SCHOOL/Capstone/bringup/ChaosCore-FPGA/ChaosCoreFPGAConfig/ChaosCore/ChaosCore.gen/sources_1/bd/BD/ip/BD_AXI_data_snoop_0_0/synth/BD_AXI_data_snoop_0_0.v
      rt::read_vhdl -lib xpm /tools/Xilinx/Vivado/2024.2/data/ip/xpm/xpm_VCOMP.vhd
      rt::filesetChecksum
    }
    rt::set_parameter usePostFindUniquification true
    set rt::SDCFileList ./.Xil/Vivado-257851-Desktop-Home/realtime/BD_AXI_data_snoop_0_0_synth.xdc
    rt::sdcChecksum
    set rt::top BD_AXI_data_snoop_0_0
...
# MODE: out_of_context
    ...
    rt::set_parameter enableSplitFlowPath "./.Xil/Vivado-257851-Desktop-Home/"
