...
HD_PWD='/mnt/Storage/SCHOOL/Capstone/bringup/ChaosCore-FPGA/ChaosCoreFPGAConfig/ChaosCore/ChaosCore.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BD_wrapper.tcl -notrace
