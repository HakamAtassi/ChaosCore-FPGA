...
module FPUFMAPipe_l3_f32(	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
  ...
  input  [32:0] io_in_bits_in1,	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:702:14]
  input  [32:0] io_in_bits_in2,	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:702:14]
  input  [32:0] io_in_bits_in3,	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:702:14]
  output [32:0] io_out_bits_data,	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:702:14]
  ...
  reg  [32:0] in_in1;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:708:15]
  reg  [32:0] in_in2;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:708:15]
  reg  [32:0] in_in3;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:708:15]
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
    ...
    if (io_in_valid) begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:702:14]
      ...
      in_in2 <= io_in_bits_swap23 ? 33'h80000000 : io_in_bits_in2;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:708:15, :714:8, :715:{23,32}]
      in_in3 <= io_in_bits_ren3 | io_in_bits_swap23 ? io_in_bits_in3 : (io_in_bits_in1 ^ io_in_bits_in2) & 33'h100000000;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:708:15, :711:{32,50}, :714:8, :716:{21,37,46}]
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
    ...
    logic [31:0] _RANDOM[0:3];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
    initial begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
        for (logic [2:0] i = 3'h0; i < 3'h4; i += 3'h1) begin
          _RANDOM[i[1:0]] = `RANDOM;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
        end	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
        valid = _RANDOM[2'h0][0];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7, :707:22]
        in_rm = _RANDOM[2'h0][22:20];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7, :707:22, :708:15]
        in_fmaCmd = _RANDOM[2'h0][24:23];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7, :707:22, :708:15]
        in_in1 = {_RANDOM[2'h0][31:29], _RANDOM[2'h1][29:0]};	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7, :707:22, :708:15]
        in_in2 = {_RANDOM[2'h1][31:30], _RANDOM[2'h2][30:0]};	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7, :708:15]
        in_in3 = {_RANDOM[2'h2][31], _RANDOM[2'h3]};	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7, :708:15]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_out_bits_data = ({33{_fma_io_out[31:29] != 3'h7}} | 33'h1EF7FFFFF) & _fma_io_out;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:249:{25,56}, :414:10, :697:7, :719:19]
endmodule
