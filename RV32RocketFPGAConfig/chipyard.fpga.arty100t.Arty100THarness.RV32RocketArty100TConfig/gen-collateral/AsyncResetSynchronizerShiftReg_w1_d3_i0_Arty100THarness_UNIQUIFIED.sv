...
module AsyncResetSynchronizerShiftReg_w1_d3_i0_Arty100THarness_UNIQUIFIED(	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:80:7]
  ...
  AsyncResetSynchronizerPrimitiveShiftReg_d3_i0 output_chain (	// @[generators/rocket-chip/src/main/scala/util/ShiftReg.scala:45:23]
    .clock (clock),
    .reset (reset),
    .io_d  (1'h1),	// @[generators/rocket-chip/src/main/scala/util/ShiftReg.scala:36:14, :45:23]
    .io_q  (io_q)
