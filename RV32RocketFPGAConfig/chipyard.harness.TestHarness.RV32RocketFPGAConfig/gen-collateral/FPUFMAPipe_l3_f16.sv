...
module FPUFMAPipe_l3_f16(	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7]
    ...
    if (io_in_valid) begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:702:14]
      ...
      in_in2 <= io_in_bits_swap23 ? 33'h8000 : io_in_bits_in2;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:708:15, :714:8, :715:{23,32}]
      in_in3 <= io_in_bits_ren3 | io_in_bits_swap23 ? io_in_bits_in3 : {16'h0, (io_in_bits_in1[16:0] ^ io_in_bits_in2[16:0]) & 17'h10000};	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:702:14, :708:15, :711:{32,50}, :714:8, :716:{21,37,46}]
    end
  end // always @(posedge)
  ...
  assign io_out_bits_data = {16'h0, _fma_io_out};	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:697:7, :711:50, :719:19, :729:12]
endmodule
