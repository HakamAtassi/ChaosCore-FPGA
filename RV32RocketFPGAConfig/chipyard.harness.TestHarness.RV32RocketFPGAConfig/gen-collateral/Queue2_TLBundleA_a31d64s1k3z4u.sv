...
module Queue2_TLBundleA_a31d64s1k3z4u(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  output        io_deq_bits_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  wire [114:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  ram_2x115 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({1'h0, io_enq_bits_data, io_enq_bits_mask, io_enq_bits_address, 1'h0, io_enq_bits_size, 3'h0, io_enq_bits_opcode})	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :255:14, :256:91]
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[10];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_address = _ram_ext_R0_data[41:11];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_mask = _ram_ext_R0_data[49:42];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_data = _ram_ext_R0_data[113:50];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[114];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
