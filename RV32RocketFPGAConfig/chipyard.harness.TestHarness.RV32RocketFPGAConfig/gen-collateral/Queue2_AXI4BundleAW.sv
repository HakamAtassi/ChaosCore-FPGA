...
module Queue2_AXI4BundleAW(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  wire [58:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  ram_2x59 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_qos, io_enq_bits_prot, io_enq_bits_cache, io_enq_bits_lock, io_enq_bits_burst, io_enq_bits_size, io_enq_bits_len, io_enq_bits_addr, io_enq_bits_id})	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  assign io_deq_bits_addr = _ram_ext_R0_data[33:4];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
