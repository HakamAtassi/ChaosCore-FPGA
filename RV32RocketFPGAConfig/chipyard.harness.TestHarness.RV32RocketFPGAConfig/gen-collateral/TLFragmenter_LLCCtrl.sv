...
module TLFragmenter_LLCCtrl(	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9]
  ...
  TLMonitor_17 monitor (	// @[generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:27:25]
    .clock                (clock),
    .reset                (reset),
    ...
    .io_in_d_bits_source  (auto_anon_out_d_bits_source[7:4]),	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:238:47]
  ...
  Repeater_TLBundleA_a26d64s4k1z3u repeater (	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:274:30]
    .clock               (clock),
    .reset               (reset),
  ...
  assign auto_anon_in_d_bits_param = auto_anon_out_d_bits_param;	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9]
  ...
  assign auto_anon_in_d_bits_sink = auto_anon_out_d_bits_sink;	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9]
  assign auto_anon_in_d_bits_denied = auto_anon_out_d_bits_denied;	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9]
  ...
  assign auto_anon_in_d_bits_corrupt = auto_anon_out_d_bits_corrupt;	// @[generators/rocket-chip/src/main/scala/tilelink/Fragmenter.scala:92:9]
