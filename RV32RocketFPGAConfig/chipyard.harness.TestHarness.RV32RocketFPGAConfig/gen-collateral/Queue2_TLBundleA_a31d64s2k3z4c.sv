...
module Queue2_TLBundleA_a31d64s2k3z4c(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  input  [1:0]  io_enq_bits_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  output [1:0]  io_deq_bits_source,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  wire [115:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  ram_2x116 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({1'h0, io_enq_bits_data, io_enq_bits_mask, io_enq_bits_address, io_enq_bits_source, io_enq_bits_size, io_enq_bits_param, io_enq_bits_opcode})	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[11:10];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_address = _ram_ext_R0_data[42:12];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_mask = _ram_ext_R0_data[50:43];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_data = _ram_ext_R0_data[114:51];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[115];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
