...
set genomeRtd $env(RT_TMP)/6D4DC700.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {RocketTile__GB3}]"
...
set genomeName [subst -nocommands -novariables {RocketTile__GB3}]
