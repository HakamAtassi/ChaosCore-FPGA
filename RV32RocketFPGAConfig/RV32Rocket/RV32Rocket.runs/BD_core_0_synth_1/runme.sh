...
HD_PWD='/home/hakam/Repos/ChaosCore-FPGA/RV32RocketFPGAConfig/RV32Rocket/RV32Rocket.runs/BD_core_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BD_core_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BD_core_0.tcl
