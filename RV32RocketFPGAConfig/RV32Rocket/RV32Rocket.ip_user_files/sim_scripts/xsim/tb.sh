...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_19 -L zynq_ultra_ps_e_vip_v1_0_19 -L axi_lite_ipif_v3_0_4 -L lib_cdc_v1_0_3 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_35 -L generic_baseblocks_v2_1_2 -L axi_register_slice_v2_1_33 -L fifo_generator_v13_2_11 -L axi_data_fifo_v2_1_32 -L axi_crossbar_v2_1_34 -L axi_protocol_converter_v2_1_33 -L axi_clock_converter_v2_1_32 -L blk_mem_gen_v8_4_9 -L axi_dwidth_converter_v2_1_33 -L proc_sys_reset_v5_0_16 -L axi_bram_ctrl_v4_1_11 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot tb xil_defaultlib.tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tb -key {Behavioral:sim_1:Functional:tb} -tclbatch cmd.tcl -protoinst "protoinst_files/mpsoc_preset.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tb.wdb xsim.dir libdpi.so)
