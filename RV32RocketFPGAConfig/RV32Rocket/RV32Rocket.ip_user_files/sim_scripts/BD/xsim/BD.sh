...
simulate()
{
  xsim BD -key {Behavioral:sim_1:Functional:BD} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_9ccc.protoinst" -protoinst "protoinst_files/BD.protoinst" -log simulate.log
}
