...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_19 -L smartconnect_v1_0 -L zynq_ultra_ps_e_vip_v1_0_19 -L xilinx_vip"
...
simulate()
{
  xsim BD -key {Behavioral:sim_1:Functional:BD} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_9ccc.protoinst" -protoinst "protoinst_files/bd_4797.protoinst" -protoinst "protoinst_files/BD.protoinst" -log simulate.log
}
