...
(* CORE_GENERATION_INFO = "BD,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=BD,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=3,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=10,da_board_cnt=1,da_clkrst_cnt=7,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "BD.hwdef" *) 
module BD
   (heartbeat,
    rst_led);
  output heartbeat;
  ...
  BD_core_0 core
       (.M_AXI_MEM_ACLK(core_M_AXI_MEM_ACLK),
        ...
        .M_AXI_MMIO_ARREADY(1'b0),
        .M_AXI_MMIO_AWREADY(1'b0),
        .M_AXI_MMIO_BID({1'b0,1'b0,1'b0,1'b0}),
        .M_AXI_MMIO_BRESP({1'b0,1'b0}),
        .M_AXI_MMIO_BVALID(1'b0),
        .M_AXI_MMIO_RDATA({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .M_AXI_MMIO_RID({1'b0,1'b0,1'b0,1'b0}),
        .M_AXI_MMIO_RLAST(1'b0),
        .M_AXI_MMIO_RRESP({1'b0,1'b0}),
        .M_AXI_MMIO_RVALID(1'b0),
        .M_AXI_MMIO_WREADY(1'b0),
