...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E00B8 0x01003F07 0x01000302
		...
		# 6 bit divider
		# PSU_CRL_APB_PL0_REF_CTRL_DIVISOR1                                               0xf

		# 6 bit divider
		# PSU_CRL_APB_PL0_REF_CTRL_DIVISOR0                                               0x14
    ...
    #  usually an issue, but designers must be aware.)
		...
		# This register controls this reference clock
		#(OFFSET, MASK, VALUE)      (0XFF5E00C0, 0x013F3F07U ,0x010F1400U)  */
    mask_write 0XFF5E00C0 0x013F3F07 0x010F1400
		# Register : AMS_REF_CTRL @ 0XFF5E0108</p>
