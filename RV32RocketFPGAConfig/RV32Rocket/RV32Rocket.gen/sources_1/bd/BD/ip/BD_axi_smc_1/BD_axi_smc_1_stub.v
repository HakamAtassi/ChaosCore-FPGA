...
(* CHECK_LICENSE_TYPE = "BD_axi_smc_1,bd_9ccc,{}" *) (* CORE_GENERATION_INFO = "BD_axi_smc_1,bd_9ccc,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=25,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "bd_9ccc,Vivado 2024.2" *) 
module BD_axi_smc_1(aclk, aresetn, S00_AXI_awid, S00_AXI_awaddr, 
