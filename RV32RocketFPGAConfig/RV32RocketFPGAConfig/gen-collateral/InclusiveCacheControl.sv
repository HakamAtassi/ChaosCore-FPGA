...
module InclusiveCacheControl(	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Control.scala:38:9]
  ...
  input  [7:0]  auto_ctrl_in_a_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  output [7:0]  auto_ctrl_in_d_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  TLMonitor_27 monitor (	// @[generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:27:25]
    .clock                (clock),
    .reset                (reset),
