...
module RecFNToIN_e8_s24_i32(	// @[generators/hardfloat/hardfloat/src/main/scala/RecFNToIN.scala:46:7]
  ...
  wire        roundIncr = io_roundingMode == 3'h0 & (io_in[31] & ((&(shiftedSig[23:22])) | (&_roundIncr_near_even_T_6)) | magJustBelowOne & (|_roundIncr_near_even_T_6)) | io_roundingMode == 3'h4 & (io_in[31] & shiftedSig[22] | magJustBelowOne) | (io_roundingMode == 3'h2 | roundingMode_odd) & io_in[32] & common_inexact | io_roundingMode == 3'h3 & ~(io_in[32]) & common_inexact;	// @[generators/hardfloat/hardfloat/src/main/scala/RecFNToIN.scala:61:30, :63:37, :67:53, :69:53, :70:53, :71:53, :72:53, :83:49, :92:{29,50}, :94:{25,39,46,51,71,78}, :95:{26,46}, :96:{43,56,61}, :98:{35,61}, :99:{35,61}, :100:{28,49}, :101:{26,46}, :102:{27,31,43}, generators/hardfloat/hardfloat/src/main/scala/rawFloatFromRecFN.scala:59:25]
  ...
  wire        roundCarryBut2 = (&(shiftedSig[52:23])) & roundIncr;	// @[generators/hardfloat/hardfloat/src/main/scala/RecFNToIN.scala:83:49, :90:52, :98:61, :99:61, :101:46, :113:{38,56,61}]
  wire        common_overflow = io_in[31] ? (|(io_in[30:28])) | (io_signedOut ? (io_in[32] ? magGeOne_atOverflowEdge & ((|(shiftedSig[53:23])) | roundIncr) : magGeOne_atOverflowEdge | io_in[30:23] == 8'h1E & roundCarryBut2) : io_in[32] | magGeOne_atOverflowEdge & shiftedSig[53] & roundCarryBut2) : ~io_signedOut & io_in[32] & roundIncr;	// @[generators/hardfloat/hardfloat/src/main/scala/RecFNToIN.scala:61:30, :62:28, :83:49, :90:52, :98:61, :99:61, :101:46, :110:43, :113:61, :115:12, :116:{21,36}, :117:20, :118:24, :119:49, :120:{42,60,64}, :121:49, :122:{38,60}, :124:32, :125:50, :126:{42,57}, :128:{13,27,41}, generators/hardfloat/hardfloat/src/main/scala/rawFloatFromRecFN.scala:59:25]
