...
module Queue2_AXI4BundleR_1(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  input         io_enq_bits_echo_real_last,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  output        io_deq_bits_echo_real_last,	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14]
  ...
  ram_2x72 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({1'h1, io_enq_bits_echo_real_last, 2'h0, io_enq_bits_data, io_enq_bits_id})	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14, :256:91]
  ...
  assign io_deq_bits_echo_real_last = _ram_ext_R0_data[70];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_last = _ram_ext_R0_data[71];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
