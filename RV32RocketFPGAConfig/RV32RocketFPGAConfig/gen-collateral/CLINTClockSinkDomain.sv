...
module CLINTClockSinkDomain(	// @[generators/rocket-chip/src/main/scala/prci/ClockDomain.scala:14:9]
  ...
  input  [6:0]  auto_clint_in_a_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  output [6:0]  auto_clint_in_d_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  output        auto_int_in_clock_xing_out_sync_1,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  wire _clint_auto_int_out_0;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/CLINT.scala:112:48]
  wire _clint_auto_int_out_1;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/CLINT.scala:112:48]
  ...
  IntSyncCrossingSource_n1x2 intsource (	// @[generators/rocket-chip/src/main/scala/interrupts/Crossing.scala:29:31]
    .clock           (auto_clock_in_clock),
    .reset           (auto_clock_in_reset),
    .auto_in_0       (_clint_auto_int_out_0),	// @[generators/rocket-chip/src/main/scala/devices/tilelink/CLINT.scala:112:48]
    .auto_in_1       (_clint_auto_int_out_1),	// @[generators/rocket-chip/src/main/scala/devices/tilelink/CLINT.scala:112:48]
