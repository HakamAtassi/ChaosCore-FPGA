...
module TileClockGater(	// @[generators/chipyard/src/main/scala/clocking/TileClockGater.scala:27:25]
  ...
  input         reset,	// @[generators/chipyard/src/main/scala/clocking/TileClockGater.scala:27:25]
  ...
  input  [2:0]  auto_clock_gater_in_1_a_bits_param,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  input         auto_clock_gater_in_1_a_bits_corrupt,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  wire [2:0] monitor_io_in_d_bits_opcode = {2'h0, in_bits_read};	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:74:36, :105:19]
  TLMonitor_42 monitor (	// @[generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:27:25]
    ...
    .io_in_d_bits_opcode  (monitor_io_in_d_bits_opcode),	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:105:19]
  ...
  assign auto_clock_gater_in_1_d_bits_opcode = monitor_io_in_d_bits_opcode;	// @[generators/chipyard/src/main/scala/clocking/TileClockGater.scala:27:25, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:105:19]
