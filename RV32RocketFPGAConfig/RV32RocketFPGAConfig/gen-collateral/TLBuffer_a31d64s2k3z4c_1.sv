...
module TLBuffer_a31d64s2k3z4c_1(	// @[generators/rocket-chip/src/main/scala/tilelink/Buffer.scala:40:9]
  ...
  output [2:0]  auto_in_b_bits_opcode,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  output [1:0]  auto_in_b_bits_param,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  output [3:0]  auto_in_b_bits_size,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  output [1:0]  auto_in_b_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  output [30:0] auto_in_b_bits_address,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  output [7:0]  auto_in_b_bits_mask,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  output        auto_in_b_bits_corrupt,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  input  [3:0]  auto_in_c_bits_size,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  output        auto_in_e_ready,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  output [1:0]  auto_out_c_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  input  [1:0]  auto_out_d_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  wire        _nodeOut_e_q_io_enq_ready;	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
  wire        _nodeOut_c_q_io_enq_ready;	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
  wire        _nodeIn_b_q_io_deq_valid;	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
  wire [2:0]  _nodeIn_b_q_io_deq_bits_opcode;	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
  wire [1:0]  _nodeIn_b_q_io_deq_bits_param;	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
  wire [3:0]  _nodeIn_b_q_io_deq_bits_size;	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
  wire [1:0]  _nodeIn_b_q_io_deq_bits_source;	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
  wire [30:0] _nodeIn_b_q_io_deq_bits_address;	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
  wire [7:0]  _nodeIn_b_q_io_deq_bits_mask;	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
  wire        _nodeIn_b_q_io_deq_bits_corrupt;	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  wire [1:0]  _nodeIn_d_q_io_deq_bits_source;	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
  wire [2:0]  _nodeIn_d_q_io_deq_bits_sink;	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  TLMonitor_34 monitor (	// @[generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:27:25]
    ...
    .io_in_b_valid        (_nodeIn_b_q_io_deq_valid),	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .io_in_b_bits_opcode  (_nodeIn_b_q_io_deq_bits_opcode),	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .io_in_b_bits_param   (_nodeIn_b_q_io_deq_bits_param),	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .io_in_b_bits_size    (_nodeIn_b_q_io_deq_bits_size),	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .io_in_b_bits_source  (_nodeIn_b_q_io_deq_bits_source),	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .io_in_b_bits_address (_nodeIn_b_q_io_deq_bits_address),	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .io_in_b_bits_mask    (_nodeIn_b_q_io_deq_bits_mask),	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .io_in_b_bits_corrupt (_nodeIn_b_q_io_deq_bits_corrupt),	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .io_in_c_ready        (_nodeOut_c_q_io_enq_ready),	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    ...
    .io_in_e_ready        (_nodeOut_e_q_io_enq_ready),	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  Queue2_TLBundleA_a31d64s2k3z4c nodeOut_a_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue2_TLBundleD_a31d64s2k3z4c nodeIn_d_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue2_TLBundleB_a31d64s2k3z4c nodeIn_b_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue2_TLBundleC_a31d64s2k3z4c nodeOut_c_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue2_TLBundleE_a31d64s2k3z4c nodeOut_e_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock            (clock),
    .reset            (reset),
  ...
  assign auto_in_b_valid = _nodeIn_b_q_io_deq_valid;	// @[generators/rocket-chip/src/main/scala/tilelink/Buffer.scala:40:9, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  assign auto_in_b_bits_opcode = _nodeIn_b_q_io_deq_bits_opcode;	// @[generators/rocket-chip/src/main/scala/tilelink/Buffer.scala:40:9, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  assign auto_in_b_bits_param = _nodeIn_b_q_io_deq_bits_param;	// @[generators/rocket-chip/src/main/scala/tilelink/Buffer.scala:40:9, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  assign auto_in_b_bits_size = _nodeIn_b_q_io_deq_bits_size;	// @[generators/rocket-chip/src/main/scala/tilelink/Buffer.scala:40:9, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  assign auto_in_b_bits_source = _nodeIn_b_q_io_deq_bits_source;	// @[generators/rocket-chip/src/main/scala/tilelink/Buffer.scala:40:9, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  assign auto_in_b_bits_address = _nodeIn_b_q_io_deq_bits_address;	// @[generators/rocket-chip/src/main/scala/tilelink/Buffer.scala:40:9, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  assign auto_in_b_bits_mask = _nodeIn_b_q_io_deq_bits_mask;	// @[generators/rocket-chip/src/main/scala/tilelink/Buffer.scala:40:9, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  assign auto_in_b_bits_corrupt = _nodeIn_b_q_io_deq_bits_corrupt;	// @[generators/rocket-chip/src/main/scala/tilelink/Buffer.scala:40:9, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  assign auto_in_c_ready = _nodeOut_c_q_io_enq_ready;	// @[generators/rocket-chip/src/main/scala/tilelink/Buffer.scala:40:9, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  assign auto_in_e_ready = _nodeOut_e_q_io_enq_ready;	// @[generators/rocket-chip/src/main/scala/tilelink/Buffer.scala:40:9, src/main/scala/chisel3/util/Decoupled.scala:362:21]
endmodule
