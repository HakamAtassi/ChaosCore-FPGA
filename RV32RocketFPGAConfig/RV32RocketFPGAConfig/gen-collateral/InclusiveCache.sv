...
module InclusiveCache(	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/InclusiveCache.scala:108:9]
  ...
  input  [7:0]  auto_ctrls_ctrl_in_a_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  output [7:0]  auto_ctrls_ctrl_in_d_bits_source,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  wire [30:0] _inclusive_cache_bank_sched_io_in_b_bits_address;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/InclusiveCache.scala:137:29]
  ...
  wire [2:0]  _inclusive_cache_bank_sched_io_in_d_bits_source;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/InclusiveCache.scala:137:29]
  ...
  wire        contained = {_ctrls_io_flush_req_bits[63:31], _ctrls_io_flush_req_bits[30:28] ^ 3'h4} == 36'h0 | {_ctrls_io_flush_req_bits[63:28], _ctrls_io_flush_req_bits[27:16] ^ 12'h800} == 48'h0;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/InclusiveCache.scala:103:43, :169:67, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:{31,41,46,59}]
  ...
  TLMonitor_28 monitor (	// @[generators/rocket-chip/src/main/scala/tilelink/Nodes.scala:27:25]
    .clock                (clock),
    .reset                (reset),
  ...
  InclusiveCacheBankScheduler inclusive_cache_bank_sched (	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/InclusiveCache.scala:137:29]
    ...
    .io_req_bits_address   (_ctrls_io_flush_req_bits[30:0]),	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/InclusiveCache.scala:103:43, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:137:31]
