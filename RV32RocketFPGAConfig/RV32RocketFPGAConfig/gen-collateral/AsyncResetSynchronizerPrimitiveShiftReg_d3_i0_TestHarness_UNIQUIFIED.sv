...
module AsyncResetSynchronizerPrimitiveShiftReg_d3_i0_TestHarness_UNIQUIFIED(	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:68:19]
  ...
  always @(posedge clock or posedge reset) begin	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:68:19]
    if (reset) begin	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:68:19]
      ...
      sync_2 <= 1'h1;	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:51:87, :68:19]
    end
