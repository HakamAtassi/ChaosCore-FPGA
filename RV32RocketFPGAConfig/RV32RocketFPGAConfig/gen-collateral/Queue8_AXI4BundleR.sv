...
module Queue8_AXI4BundleR(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  wire [76:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  wire        do_deq = io_deq_ready & ~(ptr_match & ~maybe_full);	// @[src/main/scala/chisel3/util/Decoupled.scala:51:35, :259:27, :260:33, :261:{25,28}, :285:19]
  ...
  ram_8x77 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_last, io_enq_bits_echo_tl_state_source, io_enq_bits_echo_tl_state_size, io_enq_bits_resp, io_enq_bits_data, io_enq_bits_id})	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  assign io_deq_bits_data = _ram_ext_R0_data[67:4];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_resp = _ram_ext_R0_data[69:68];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_echo_tl_state_size = _ram_ext_R0_data[73:70];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_echo_tl_state_source = _ram_ext_R0_data[75:74];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_last = _ram_ext_R0_data[76];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
