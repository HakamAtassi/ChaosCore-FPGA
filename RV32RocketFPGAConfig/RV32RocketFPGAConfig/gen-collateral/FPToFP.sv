...
module FPToFP(	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7]
  ...
  wire [32:0] fsgnjMux_data = _GEN ? ((&(in_pipe_b_in1[31:29])) ? 33'hE0400000 : in_pipe_b_in1) : in_pipe_b_wflags ? ((&(in_pipe_b_in1[31:29])) & (&(in_pipe_b_in2[31:29])) ? 33'hE0400000 : (&(in_pipe_b_in2[31:29])) | in_pipe_b_rm[0] != io_lt & ~(&(in_pipe_b_in1[31:29])) ? in_pipe_b_in1 : in_pipe_b_in2) : {in_pipe_b_rm[1] ? in_pipe_b_in1[32] ^ in_pipe_b_in2[32] : in_pipe_b_rm[0] ^ in_pipe_b_in2[32], in_pipe_b_in1[31:0]};	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:249:{25,56}, :582:{20,31,48,66,77}, :583:{18,45}, :587:17, :589:25, :593:27, :594:{24,41,51,54}, :596:{19,25,53}, :608:{24,42}, :611:24, :612:21, src/main/scala/chisel3/util/Valid.scala:142:26]
  ...
  wire [5:0]  _mux_data_expOut_commonCase_T = fsgnjMux_data[28:23] - 6'h20;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:276:18, :280:31, :589:25, :608:42, :612:21]
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7]
    ...
    if (in_pipe_v) begin	// @[src/main/scala/chisel3/util/Valid.scala:141:24]
      io_out_pipe_b_data <= _GEN_0 ? (_GEN ? {fsgnjMux_data[32:17], _narrower_io_out} : {fsgnjMux_data[32:17], fsgnjMux_data[32], fsgnjMux_data[31:29] == 3'h0 | fsgnjMux_data[31:29] > 3'h5 ? {fsgnjMux_data[31:29], _mux_data_expOut_commonCase_T[2:0]} : _mux_data_expOut_commonCase_T, fsgnjMux_data[22:13]}) : fsgnjMux_data;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:274:17, :276:18, :277:38, :279:26, :280:{31,50}, :281:{10,19,27,38,49,69}, :573:7, :589:25, :601:24, :603:{18,36}, :604:{16,22,37}, :608:{24,42}, :612:21, :618:126, :619:30, :624:{18,24,39}, src/main/scala/chisel3/util/Valid.scala:142:26]
      io_out_pipe_b_exc <= _GEN & _GEN_0 ? _narrower_io_exceptionFlags : _GEN ? {(&(in_pipe_b_in1[31:29])) & ~(in_pipe_b_in1[22]), 4'h0} : in_pipe_b_wflags ? {(&(in_pipe_b_in1[31:29])) & ~(in_pipe_b_in1[22]) | (&(in_pipe_b_in2[31:29])) & ~(in_pipe_b_in2[22]), 4'h0} : 5'h0;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:249:{25,56}, :250:{34,37,39}, :586:16, :589:25, :592:49, :595:{18,31}, :601:24, :603:18, :608:{24,42}, :613:{20,51}, :618:126, :619:30, :625:17, src/main/scala/chisel3/util/Valid.scala:142:26]
    end
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7]
    ...
    logic [31:0] _RANDOM[0:5];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7]
    initial begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7]
        ...
        in_pipe_b_ren2 = _RANDOM[3'h0][4];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7, src/main/scala/chisel3/util/Valid.scala:141:24, :142:26]
        in_pipe_b_typeTagOut = _RANDOM[3'h0][11:10];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7, src/main/scala/chisel3/util/Valid.scala:141:24, :142:26]
        ...
        io_out_pipe_b_data = {_RANDOM[3'h4][31:1], _RANDOM[3'h5][1:0]};	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7, src/main/scala/chisel3/util/Valid.scala:142:26]
